...
namespace AspNetMvc.Api.Infrastructures.DataAccess.Models
{
    public class BaseContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            //string cn = @"Data Source=MACOS472F\MSSQL2014;Initial Catalog=DB_INTRA_BANK;Integrated Security=True";
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            #region Tipos de Contas Correntes
            ...
            modelBuilder.Entity<ContaCorrente>(b =>
            {
                ...
                b.Property(o => o.TipoContaId).HasColumnType("int").IsRequired();
                b.Property(o => o.Numero).HasColumnType("varchar(30)").IsRequired();
                b.Property(o => o.Digito).HasColumnType("varchar(5)");
